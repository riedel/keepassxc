...
{
    palette.setColor(QPalette::Active, QPalette::Window, QStringLiteral("#383838"));
    palette.setColor(QPalette::Inactive, QPalette::Window, QStringLiteral("#3D3D3D"));
    palette.setColor(QPalette::Disabled, QPalette::Window, QStringLiteral("#404040"));
    ...
    palette.setColor(QPalette::Disabled, QPalette::Base, QStringLiteral("#292929"));

    palette.setColor(QPalette::Active, QPalette::AlternateBase, QStringLiteral("#303036"));
    palette.setColor(QPalette::Inactive, QPalette::AlternateBase, QStringLiteral("#2E2E2E"));
    palette.setColor(QPalette::Disabled, QPalette::AlternateBase, QStringLiteral("#2E2E2E"));
    ...
    palette.setColor(QPalette::Active, QPalette::Button, QStringLiteral("#2A2A2D"));
    palette.setColor(QPalette::Inactive, QPalette::Button, QStringLiteral("#2F2F32"));
    palette.setColor(QPalette::Disabled, QPalette::Button, QStringLiteral("#343436"));
    ...
    palette.setColor(QPalette::All, QPalette::Light, QStringLiteral("#434347"));
...
void DarkStyle::polish(QWidget* widget)
{
    if (qobject_cast<QMainWindow*>(widget) || qobject_cast<QDialog*>(widget) || qobject_cast<QMenuBar*>(widget)
        ...
        palette.setColor(QPalette::All, QPalette::Window, QStringLiteral("#000000"));
#else
//        palette.setColor(QPalette::Active, QPalette::Window, QStringLiteral("#191919"));
//        palette.setColor(QPalette::Inactive, QPalette::Window, QStringLiteral("#232323"));
//        palette.setColor(QPalette::Disabled, QPalette::Window, QStringLiteral("#222222"));
#endif
